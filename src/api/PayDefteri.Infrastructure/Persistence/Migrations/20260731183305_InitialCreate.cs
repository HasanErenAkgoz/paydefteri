        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryInstallmentId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_installments_plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPct = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_installment_shares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_installment_shares_installments_InstallmentId",
                        column: x => x.InstallmentId,
                        principalTable: "installments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_installment_shares_partners_PartnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_payments_partners_PaidByPartnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_installment_shares_InstallmentId_PartnerId",
                table: "installment_shares",
                columns: new[] { "InstallmentId", "PartnerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_installment_shares_PartnerId",
                table: "installment_shares",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_installments_PlanId",
                table: "installments",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payments_InstallmentId_PartnerId",
                table: "payments",
                columns: new[] { "InstallmentId", "PartnerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_payments_PaidByPartnerId",
                table: "payments",
