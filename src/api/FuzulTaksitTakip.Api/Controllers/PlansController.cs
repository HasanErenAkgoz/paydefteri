...
public sealed class PlansController : ControllerBase
{
    ...
    public async Task<ActionResult<PlanDto>> SeedTemplate(Guid planId, string templateKey, CancellationToken ct)
        => Ok(await _sender.Send(new SeedPlanTemplateCommand(planId, templateKey), ct));
