...
using FuzulTaksitTakip.Api.Middleware;
using FuzulTaksitTakip.Application;
using FuzulTaksitTakip.Infrastructure;
...
if (!app.Environment.IsEnvironment("Testing"))
{
    ...
    await FuzulTaksitTakip.Infrastructure.Identity.IdentityDataSeeder.SeedAsync(scope.ServiceProvider);
}
